...
package controller.exam.student;
...
public class StudentViewGradeController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StudentViewGradeController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StudentViewGradeController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//            ArrayList<Student> students = stuDB.getStudentsByCourse(cid);
            ...
            request.getRequestDispatcher("../view/exam/grade.jsp").forward(request, response);
        }
    } 
