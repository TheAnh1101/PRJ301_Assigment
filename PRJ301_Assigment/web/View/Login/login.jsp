    ...
    <body>
        <div id="logreg-forms">
            ...
            <form class="form-signup" action="signup" method="post" >
                ...
                <p class="text-danger">${messCheckP}</p>
                <p class="text-danger">${messCheckU}</p>
                <input name="fullname" type="text" id="user-fullname" class="form-control" placeholder="Full name" required autofocus="">
                <input name="email" type="email" id="user-email" class="form-control" placeholder="User email" required >
                <input name="address" type="text" id="user-address" class="form-control" placeholder="User address" required >
        ...
        <script>
            ...
            <% if (request.getAttribute("messCheckP") != null) { %>
                // neu co thong bao loi, an form dang nhap va hien form dang ki
                $('#logreg-forms .form-signin').hide();
                $('#logreg-forms .form-signup').show();
            <% } %>
            });
            $(document).ready(function () {
            <% if (request.getAttribute("messCheckU") != null) { %>
                // neu co thong bao loi, an form dang nhap va hien form dang ki
                $('#logreg-forms .form-signin').hide();
                $('#logreg-forms .form-signup').show();
            <% } %>
